...
#Palabras
ANSWERS = ['abeja', 'ancho', 'agua', 'alba', 'aire', 'ancla', 'arte', 'arena',
           'balón', 'barco', 'burro', 'banco', 'brillo', 'bomba', 'botella',
           'broche', 'bruja', 'bisonte', 'cielo', 'carro', 'carbono', 'cereza',
           'caballo', 'ciruela', 'costa', 'campo', 'corona', 'cuadro', 'dedo',
           'dulce', 'duna', 'doble', 'danza', 'dorado', 'duelo', 'diamante', 'dato',
           'deseo', 'eco', 'elevar', 'estrella', 'espejo', 'feroz', 'fuerza', 'fuego',
           'flor', 'franja', 'fantasma', 'fresco', 'guitarra', 'globo', 'gente', 'grito',
           'hoja', 'humo', 'héroe', 'idea', 'isla', 'jardín', 'jirafa']
